...
public class KafkaConsumerService {
    ...
    private static final String GROUP_ID = "evaluation-service";
    ...
    private void handleUserCreated(UserEventDto event) {
        ...
        // Add custom logic here, e.g., cache user info, create default ratings, etc.
    }
    ...
    private void handleUserDeleted(UserEventDto event) {
        ...
        // Add custom logic here, e.g., cleanup related data
    }
}
